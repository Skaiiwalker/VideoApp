...
public class SoundActivity extends Activity implements Runnable
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        soundPlayer = MediaPlayer.create(this.getBaseContext(), R.raw.ASadnessRunsThroughHim);
    ...
    private void setupListeners()
    {
        ...
        stopButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View currentView) {
                soundPlayer.stop();
                soundPlayer = MediaPlayer.create(getBaseContext(), R.raw.ASadnessRunsThroughHim);
            }
        });
    ...
    public void run()
    {
        ...
        while (soundPlayer != null && currentPosition < soundTotal)
        {
            ...
            catch(InterruptedException soudnException)
            {
                return;
            }
